...
class Favourites(db.Model):
    id = db.Column(db.Integer, primary_key=True,  autoincrement=True)
    car_id = db.Column(db.Integer, db.ForeignKey('cars_model.id',ondelete='CASCADE'))
    user_id = db.Column(db.Integer, db.ForeignKey('users.id', ondelete='CASCADE'))

    liked_car = db.relationship('CarsModel',back_populates="liked_car",passive_deletes=True)
    user_liked = db.relationship('Users',back_populates="user_liked",passive_deletes=True)
